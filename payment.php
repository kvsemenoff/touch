                ...
                <tbody>
                    <tr>
                        ...
                        <td class="personal__info-item">
                            ...
                            <input type="text" class="payment__input" id="user__phone" name="user__phone" placeholder="00 000 000 00 00" class="personal__info-text user__phone">
                        </td>
                        <td class="personal__info-item">
                        ...
                        <td class="personal__info-item td__bg">
                            <label class="personal__label data__arrow" for="personal__data">Выберите дату
            ...
            <table class="payment__table extra__table">
                <tbody>
                    <tr class="personal__info-bottom">
                        ...
                        <td class="personal__info-item">
                            <label class="personal__label data__arrow">
                                <span class="date__arow modified__arrow"></span>
                            </label>
                            <select class="personal__select data__arrow extra__select" name="personal__time" id="personal__time">
                                <option value="choose__marina">Выберите марину</option>
                            </select>
                            <input type="text" class="payment__input extra__input" id="user__phone" name="user__phone" placeholder="Название чартерной компании или отеля" >
                            <input type="text" class="payment__input extra__input" id="user__phone" name="user__phone" placeholder="Название лодки или отеля">
                        </td>
                        <td class="personal__info-item">
